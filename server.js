...
app.post(
  ...
  {
    input: {
      prompt: "Replace only the uploaded garment. Keep everything else exactly the same, including the person's identity, pose, body, face, hairstyle, background, and lighting. Apply the garment naturally and accurately.",
